...
const mockUserOverAllocated: UserWorkloadData = {
  ...
  name: 'Max Overload',
  currentAssignments: [
    { projectId: 'p1', projectName: 'Skyscraper Heights', allocatedHours: 30 },
    { projectId: 'p2', projectName: 'Parkside Pavilion', allocatedHours: 20 }, // Total 50h > 40h capacity
  ],
};
  ...
  currentAssignments: [
    {
      ...
      allocatedHours: 5,
      projectDeadline: new Date(2025, 8, 15),
    },
  ],
};
